...
Create a for statement using any range of numbers where maximum number is <= 1000.
For each number in the range:
    ...
    - Once the prime number counter equals three, exit the loop (Use the break statement to exit).
*/
